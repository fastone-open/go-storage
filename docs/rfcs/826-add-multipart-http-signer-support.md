...
- RFC PR: [beyondstorage/go-storage#826](https://git.fastonetech.com/fastone/go-storage/pull/826)
- Tracking Issue: [beyondstorage/go-storage#827](https://git.fastonetech.com/fastone/go-storage/issues/827)
...
In [GSP-729](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/729-redesign-http-signer.md), we split out the `HTTPSigner` proposed in [GSP-706](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/706-support-http-signer.md). We had the following problems in the implementation of GSP-706:
...
Also I propose to support `delete` in `StorageHTTPSigner`(Proposed in [GSP-729](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/729-redesign-http-signer.md#proposal)).
...
Rationale is mentioned in the [GSP-729](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/729-redesign-http-signer.md#rationale).
