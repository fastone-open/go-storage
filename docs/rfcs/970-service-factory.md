...
- RFC PR: [beyondstorage/go-storage#970](https://git.fastonetech.com/fastone/go-storage/issues/970)
- Tracking Issue: [beyondstorage/go-storage#975](https://git.fastonetech.com/fastone/go-storage/issues/975)
