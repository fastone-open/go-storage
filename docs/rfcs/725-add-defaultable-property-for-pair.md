...
- RFC PR: [beyondstorage/go-storage#725](https://git.fastonetech.com/fastone/go-storage/issues/725)
- Tracking Issue: [beyondstorage/go-storage#727](https://git.fastonetech.com/fastone/go-storage/issues/727)
...
- We need to maintain a pairs map in namespace described in [Pair map for namespace](https://git.fastonetech.com/fastone/go-storage/issues/711). There will be cross-association between `service`, `namespace` and `pair`.
