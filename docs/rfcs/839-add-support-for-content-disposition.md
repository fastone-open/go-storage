...
- RFC PR: [beyondstorage/go-storage#839](https://git.fastonetech.com/fastone/go-storage/issues/839)
- Tracking Issue: [beyondstorage/go-storage#852](https://git.fastonetech.com/fastone/go-storage/issues/852)
