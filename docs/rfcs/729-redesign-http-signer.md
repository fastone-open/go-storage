...
- RFC PR: [beyondstorage/go-storage#729](https://git.fastonetech.com/fastone/go-storage/issues/729)
- Tracking Issue: [beyondstorage/go-storage#731](https://git.fastonetech.com/fastone/go-storage/issues/731)
