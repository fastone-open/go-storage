...
- RFC PR: [beyondstorage/go-storage#700](https://git.fastonetech.com/fastone/go-storage/issues/700)
- Tracking Issue: [beyondstorage/go-storage#704](https://git.fastonetech.com/fastone/go-storage/issues/704)
...
- [Connection string needs to support config StorageFeatures and DefaultPairs](https://git.fastonetech.com/fastone/go-storage/issues/680)
