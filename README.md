...
[![License](https://img.shields.io/badge/license-apache%20v2-blue.svg)](https://git.fastonetech.com/fastone/go-storage/blob/master/LICENSE)
...
[![Build Test](https://git.fastonetech.com/fastone/go-storage/actions/workflows/build-test.yml/badge.svg)](https://git.fastonetech.com/fastone/go-storage/actions/workflows/build-test.yml)
[![Cross Build](https://git.fastonetech.com/fastone/go-storage/actions/workflows/cross-build.yml/badge.svg)](https://git.fastonetech.com/fastone/go-storage/actions/workflows/cross-build.yml)
[![Unit Test](https://git.fastonetech.com/fastone/go-storage/actions/workflows/unit-test.yml/badge.svg)](https://git.fastonetech.com/fastone/go-storage/actions/workflows/unit-test.yml)
...
import (
    ...
    "git.fastonetech.com/fastone/go-storage/services"
    "git.fastonetech.com/fastone/go-storage/types"

    // Add fs support
    _ "github.com/fastone-open/go-storage/services/fs/v4"
    // Add s3 support
    _ "github.com/fastone-open/go-storage/services/s3/v3"
    // Add gcs support
    ...
    _ "github.com/fastone-open/go-storage/services/xxx" 
)
...
More examples could be found at [go-storage-example](https://git.fastonetech.com/fastone/go-storage-example).
...
More service ideas could be found at [Service Integration Tracking](https://git.fastonetech.com/fastone/go-storage/issues/536).
...
- `mode`: object mode can be a combination of `read`, `dir`, `part` and [more](https://git.fastonetech.com/fastone/go-storage/blob/master/types/object.go#L11) 
...
Self maintained codegen [definitions](https://git.fastonetech.com/fastone/go-storage/tree/master/cmd/definitions) helps to generate all our APIs, pairs and metadata.
