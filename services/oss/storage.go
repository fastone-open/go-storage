...
import (
	...
	"github.com/fastone-open/go-storage/pkg/headers"
...
func (s *Storage) createAppend(ctx context.Context, path string, opt pairStorageCreateAppend) (o *types.Object, err error) {
	...
	// ref: [GSP-134](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/134-write-behavior-consistency.md)
...
func (s *Storage) list(ctx context.Context, path string, opt pairStorageList) (oi *types.ObjectIterator, err error) {
	if !opt.HasListMode {
		...
		// ref: [GSP-654](https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/654-unify-list-behavior.md)
...
func (s *Storage) write(ctx context.Context, path string, r io.Reader, size int64, opt pairStorageWrite) (n int64, err error) {
	...
	// ref: https://git.fastonetech.com/fastone/go-storage/blob/master/docs/rfcs/751-write-empty-file-behavior.md
	if r == nil && size != 0 {
