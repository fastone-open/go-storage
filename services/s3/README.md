[![Services Test S3](https://git.fastonetech.com/fastone/go-storage/actions/workflows/services-test-s3.yml/badge.svg)](https://git.fastonetech.com/fastone/go-storage/actions/workflows/services-test-s3.yml)

# s3

AWS S3 service support for [go-storage](https://git.fastonetech.com/fastone/go-storage).

## Install

```go
go get git.fastonetech.com/fastone/go-storage/services/s3/v3
```
